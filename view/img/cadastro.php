...
<div class="container">
	...
	<div class="row">
		...
		<p><a class="btn btn-danger btn-lg" href="#" role="button">Novo Funcionário</a></p>
	</div>
	...
	<div class="row">
		...
		<div class="col-sm-6 col-md-4">
			<div class="thumbnail">
				...
				<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eaque impedit repudiandae accusamus, ma	gnam minima.</p>
				<p><button class="btn-block btn-success btn-lg" type="submit">Saiba</button></p>
			</div>
		</div>
